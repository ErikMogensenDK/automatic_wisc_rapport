...
generelle_anbefalinger = '''Det er ofte konstruktivt, at man ikke bare ser på, hvordan man kan rumme den enkelte elevs udfordringer, men også tager hensyn ved at være opmærksom på klasse-niveau. Derfor anbefales følgende:
...
Det er vigtigt starte med at enkelte tiltag, og efter en passende mængde tid tager stilling til, om de tiltag man vælger at tage i brug har den ønskede virkning, eller en uforudset negativ effekt. Først herefter bør man tilføje eller erstatte tiltag med udgangspunkt i barnets ønsker og behov.
'''
