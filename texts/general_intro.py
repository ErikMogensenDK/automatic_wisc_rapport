...
Eksempelvist er flid, ærlighed, omtanke, nysgerrighed og mod alt sammen fuldkommen indenfor elevens kontrol, hvor antallet af løste opgaver og ens karakterer kun delvist er indenfor elevens kontrol."""

fortsat_intro_til_høj_begavelse = """En høj score på testen er ikke nødvendigvis et udtryk for at barnet ikke kan have behov for støtte.
Høj begavelse kan også være et særligt behov, da man tit vil have et behov for større faglige udfordringer, for at man også lærer at koncentrere sig og gøre sig umage.
Høj begavelse kan desuden også medføre meget høje forventninger fra omgivelserne, som det kan være svært for barnet at leve op til.
Med dette i tankerne er det vigtigt at støtte barnet i at finde værdier og mål, som relaterer sig til ting, som er indenfor barnets kontrol. 
Eksempelvist er flid, ærlighed, omtanke og mod alt sammen fuldkommen indenfor elevens kontrol, hvor antallet af løste opgaver og ens karakterer kun delvist er indenfor elevens kontrol."""
