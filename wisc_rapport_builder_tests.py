...
#		self.assertEqual(expected, actual)
	...
	def test_get_result(self):
		...
		expected = [{'mål': 'VFI', 'score': 68, '95%ki': '63-80', 'percentil': 2}, {'mål': 'VSI', 'score': 86, '95%ki': '79-96', 'percentil': 18}, {'mål': 'LRI', 'score': 67, '95%ki': '62-77', 'percentil': 1}, {'mål': 'AHI', 'score': 82, '95%ki': '76-91', 'percentil': 12}, {'mål': 'FHI', 'score': 89, '95%ki': '81-99', 'percentil': 23}, {'mål': 'HIK', 'score': 70, '95%ki': '65-78', 'percentil': 2}]
...
Disse visuelle hjælpemidler vil have til fælles, at de giver mulighed for, at man kan vende tilbage til en information, hvis man "taber" et element under den mentale bearbejdning.\n"""]
	...
	def test_get_comparison_to_mean(self):
		...
		self.assertEqual(expected, actual)
		test_score = 88
		expected = 'nedre del af gennemsnittet'
		actual = builder_test.get_comparison_to_mean(test_score)
		self.assertEqual(expected, actual)
		test_score = 116
	...
	def test_build_rapport(self):
		...
		builder_test.build_rapport('test_rapport')

	def test_build_rapport_actual(self):
